...
```
Country the occurrences we are analyzing come from:
...
## Save aggregated occurrences and mapped taxa at national level
...
```{r save_cube_belgium}
occ_cube_species_filename <- paste0(paste("cube", countries, sep = "_"), ".tsv")
write_tsv(occ_cube_species, 
          here::here("data", "processed", occ_cube_species_filename),
          na = ""
)
```
...
taxa_species_filename <- paste0(paste("cube", countries, "taxa", sep = "_"), ".tsv")
write_tsv(taxa_species, 
          here::here("data", "processed", occ_cube_species_taxa_filename),
          na = ""
)
```
